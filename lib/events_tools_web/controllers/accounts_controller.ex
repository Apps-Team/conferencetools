defmodule EventsToolsWeb.AccountsController do
  ...
  def dashboard(conn, _params, current_user, claims) do
    ...
    #  nil ->
    #    changeset = Accounts.change_profile(%EventsTools.Accounts.Profile{})
    #    profile = %{status: []}
