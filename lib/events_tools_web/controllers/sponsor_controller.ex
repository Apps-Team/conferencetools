defmodule EventsToolsWeb.SponsorController do
  use EventsToolsWeb, :controller

  alias EventsTools.Sponsors
  alias EventsTools.Organizations.Organization
  alias EventsTools.Sponsors.SponsorshipOption
  ...
  def new(conn, _params, current_user, claims) do
    changeset = Sponsors.change_sponsor(%EventsTools.Sponsors.Sponsor{organization: [], sponsorship_option: []})
