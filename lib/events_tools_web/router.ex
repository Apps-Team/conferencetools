defmodule EventsToolsWeb.Router do
  use EventsToolsWeb, :router

  import Plug.Conn
  alias EventsToolsWeb.HostParser
  ...
  pipeline :require_login do
    plug Guardian.Plug.EnsureAuthenticated, handler: EventsTools.GuardianErrorHandler
  end
