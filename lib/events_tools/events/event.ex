defmodule EventsTools.Events.Event do
  use Ecto.Schema
  use Arc.Ecto.Schema
  #import Ecto.Query
  import Ecto.Changeset

  #alias EventsTools.Events.Event
  #alias EventsTools.Accounts.User
  alias EventsTools.Repo
  alias EventsTools.SlugsEvents
  ...
  schema "events" do
    ...
    field :icon, EventsTools.Icon.Type
    field :name, :string
    ...
    many_to_many :organizers, EventsTools.Accounts.Profile, join_through: "events_organizers", on_delete: :delete_all, on_replace: :delete
    many_to_many :presentations, EventsTools.Presentations.Presentation, join_through: "presentations_events", on_delete: :delete_all, on_replace: :delete
    many_to_many :posts, EventsTools.Posts.Post, join_through: "posts_events", on_delete: :delete_all, on_replace: :delete
    timestamps()
  end
