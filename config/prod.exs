...
# EventsTools.Web.Endpoint.load_from_system_env/1 dynamically.
...
config :events_tools, EventsTools.Web.Endpoint,
  on_init: {EventsTools.Web.Endpoint, :load_from_system_env, []},
  url: [host: "localhost"],
  http: [port: 4001],
...
# start per endpoint:
#
#     config :events_tools, EventsTools.Web.Endpoint, server: true
#
