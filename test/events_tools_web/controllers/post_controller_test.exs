defmodule EventsToolsWeb.PostControllerTest do
  use EventsToolsWeb.ConnCase

  alias EventsTools.Posts

  @create_attrs %{body: "some body", date: ~D[2010-04-17], title: "some title"}
  @update_attrs %{body: "some updated body", date: ~D[2011-05-18], title: "some updated title"}
